""" Gonzalez Cesena Adan
    372799
    Ejercicios II Unidad I
    21/02/2024
"""

#Ejercicio 9
oB = ord('B') #ord vuelve el valor entero unicode del caracter que pongamos
oC= ord('C')
oD= ord('D')
ob=ord('b')
oc=ord('x')
...
five=int(input())
if five > 10000:
    di1=five // 10000 #el operador // devuelve una divicion con solamente su coeficiente
    di2=(five // 1000)%10
    di3=(five // 100)%10
    di4=(five // 10)%10
    di5=five %10
...
n2=20
n3=30
a=p*(1+r)**n1 #Exponente con (base ** exponente)
